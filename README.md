...
but you can use `--dict` flag to set path to dictionary. Dictionary must be alphabetically sorted.
...
php ./ensolved.php -g -d ./dict.txt # will download dictionary to ./dict.txt
```
